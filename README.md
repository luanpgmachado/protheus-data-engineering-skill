# Protheus Data Engineering Skill
...
- `protheus-data-engineering/SKILL.md`: instruções principais.
- `protheus-data-engineering/references/`: tabelas padrão, relacionamentos, dicionário, SQL e variações por banco.

## Escopo

Uso read-only para dados Protheus. Desenvolvimento ADVPL/TLPP e alterações do dicionário SX permanecem fora do escopo.
